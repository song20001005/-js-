...
# 打开CSV文件
with open(r"全国网格点位表.csv", mode='r') as file:
    # 创建CSV读取器
    ...
    for row in csv_reader:
        ...
        if len(row) >= 2:
            ...
            header = {
                ...
                'xweb_xhr': '1',
                'Access-Token': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ3eF8xNTM3MzM2Njk0MjEzMzQ5Mzc3IiwiaWF0IjoxNjk1MjAwNTIzfQ.shMIFKdh2RrVW6KYduwDQPN00QGjSU1b9Ep9RFtzJ-bGMQZsDA3llZKwKXg5HAMve91T0KhNaYanNVPfXHO8Vw',
            ...
            try:
                response = requests.post('https://mxsa.mxbc.net/api/v2/shopinfo/findNear', data=output, headers=header).text
